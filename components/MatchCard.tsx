...
const MatchCardComponent = ({ match }: MatchCardProps) => {
  ...
  return (
    <article className="relative rounded-2xl md:rounded-3xl bg-white border border-gray-200 p-4 sm:p-6 md:p-8 lg:p-12 shadow-lg min-h-[500px] md:min-h-[600px] w-full max-w-full">
        ...
        <div className="flex-1 w-full">
          ...
          <div className="flex flex-col sm:flex-row items-start gap-3 md:gap-4">
              ...
              <div className="mt-3 md:mt-5 flex gap-2">
                {match.startup.website && (
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 md:gap-2 rounded-lg bg-gray-50 border border-gray-300 px-2 py-1.5 md:px-2 md:py-2 text-sm md:text-base text-gray-900 font-medium w-fit hover:bg-gray-100 transition-colors cursor-pointer"
                  >
                ...
                {match.startup.yc_link && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center rounded-lg bg-gray-50 border border-gray-300 px-2 py-1.5 md:px-2 md:py-2 w-fit hover:bg-gray-100 transition-colors cursor-pointer"
                  >
                    <Image
                      src={ycLogo}
                      alt="Y Combinator"
            ...
            <div className="flex-1 w-full min-w-0">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold text-gray-900 mb-2 break-words">
                {match.startup.name}
              </h2>
              {match.startup.description && (
                <p className="text-sm sm:text-base md:text-md text-gray-600 mb-3 break-words">
                  {match.startup.description}
                </p>
              )}
            </div>
