            ...
            {!user ? (
              <>
                ...
                <Button
                  ...
                  className={`rounded-full px-4 sm:px-6 py-2 text-sm sm:text-base text-white font-medium drop-shadow-md transition-all duration-300 ${isScrolled ? 'opacity-0 pointer-events-none' : 'opacity-100 bg-white/10 hover:bg-white/20 border border-white/30'
                    }`}
                >
                  Continue
                </Button>
