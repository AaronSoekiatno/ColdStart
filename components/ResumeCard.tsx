      ...
      >
        ...
        <div className="flex flex-col gap-2">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-4 py-2 bg-black hover:bg-blue-300 text-white rounded-lg transition-all text-sm font-medium cursor-pointer"
          >
