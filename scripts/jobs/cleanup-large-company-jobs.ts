/**
 * Cleanup Large Company Jobs
 * Removes jobs from companies with ≥50 employees
 */
...
async function cleanupLargeCompanyJobs() {
  ...
  console.log('🧹 Cleanup Large Company Jobs');
  console.log('='.repeat(70));
  if (dryRun) console.log('⚠️  DRY RUN MODE - No changes will be made');
  console.log('='.repeat(70));

  // 1. Fetch all startups with team_size (with pagination)
  console.log('\n📥 Fetching startups with team_size data...');
