...
CREATE TABLE IF NOT EXISTS interview_sessions (
    ...
    repo_url TEXT,  -- e.g., "https://github.com/minerva-interviews/session-abc123"
...
COMMENT ON COLUMN interview_sessions.repo_name IS 'Name of temporary Minerva-controlled repo (e.g., "session-abc123")';
COMMENT ON COLUMN interview_sessions.repo_url IS 'Full GitHub URL to temporary repo under minerva-interviews organization';
