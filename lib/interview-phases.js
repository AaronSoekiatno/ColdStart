 ...
 * Phase 3: REFLECTION - Candidate reflects on what they did
 */
 ...
 * Phase 3 (Reflection): Vapi ON - Candidate reflects on their work
 */
export const PHASES = {
    KICK_OFF: {
        id: 'KICK_OFF',
    ...
    BUILD: {
        ...
        name: 'The Build',
        order: 2,
        duration: 1 * 60, // 1 minute in seconds (testing)
        vapiActive: false,
        assistantType: null,
...
export const PHASE_ORDER = ['KICK_OFF', 'BUILD', 'REFLECTION'];
