...
export default function CandidateFullProfilePage() {
  ...
  async function triggerVerification(skip_ai: boolean = false) {
    try {
      setIsVerifying(true);
      setError(null);
              ...
              >
                {isVerifying ? (
                  ...
                  <>
                    ...
                    {latestVerification ? 'Deep Re-Verify' : 'Deep Verify'}
                  </>
                )}
              </Button>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 md:col-span-1">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-mono font-medium text-gray-900">{resumes.length}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Startup Matches</span>
                  <span className="font-mono font-medium text-gray-900">{matches.length}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Education</span>
                  <span className="font-medium text-right text-sm text-gray-900">{candidate.education_level || 'Not specified'}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Experience</span>
                  <span className="font-medium text-gray-900">{candidate.years_of_experience || '0'} years</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            {!latestVerification ? (
              <div className="bg-white rounded-lg shadow p-12 text-center">
                ...
                <Button onClick={() => triggerVerification(false)}>Run First Verification</Button>
              </div>
            ) : (
              <div className="space-y-6">
                {/* Project Matches */}
