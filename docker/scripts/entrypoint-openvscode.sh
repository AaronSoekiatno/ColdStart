...
# OpenVSCode Server Edition (Copilot-free)
# ============================================

echo "🚀 Starting Hermes Assessment Environment (OpenVSCode Server)..."
echo "============================================"
...
# ============================================
# MAIN: Setup and Start OpenVSCode Server
# ============================================

echo "🛠️  Verifying configuration..."

# Block Copilot domains (belt and suspenders - shouldn't be needed with openvscode)
if [ -w "/etc/hosts" ]; then
...
echo "🖥️  Starting OpenVSCode Server on 0.0.0.0:8080..."

# Start openvscode-server
# Note: openvscode-server uses different flags than code-server
